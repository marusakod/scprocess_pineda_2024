---
title: "Zoom in and recluster: myeloid"
author:
- name: Will Macnair
  affiliation:
...
knitr::opts_chunk$set( autodep=TRUE, cache=TRUE, cache.lazy=FALSE, dev='png', warnings = FALSE, message = FALSE, 
  fig.path = "figure/pineda_zoom_myeloid.Rmd/")
...
zoom_dir      = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom"
zoom_name     = "myeloid"
sub_dir       = file.path(zoom_dir, zoom_name)

batch_var     = "sample_id"
# define files for calculating pseudobulk marker genes
metadata_f    = "/pstore/data/brain-sc-analysis/studies/pineda_2024/data/metadata/pineda_2024_harmonized_metadata.csv"
gtf_dt_f      = "/pstore/data/neurogenomics/resources/scdata/reference_genomes/human_2024/human_2024_genes_gtf.txt.gz"
qc_f          = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_qc/qc_all_samples_pineda_2024_2026-02-28.csv.gz"
cell_hvgs_f   = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/hvg_dt_pineda_2024_myeloid_2026-02-28.csv.gz"
int_f         = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/integrated_dt_pineda_2024_myeloid_2026-02-28.csv.gz"
pb_f          = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/pb_pineda_2024_myeloid_0.5_2026-02-28.rds"
pb_hvgs_f     = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/pb_hvgs_pineda_2024_myeloid_0.5_2026-02-28.csv.gz"
mkrs_f        = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/pb_marker_genes_pineda_2024_myeloid_0.5_2026-02-28.csv.gz"
empty_gs_f    = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/edger_empty_genes_pineda_2024_myeloid_2026-02-28.csv.gz"
pb_empty_f    = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_pseudobulk/pb_empties_pineda_2024_2026-02-28.rds"

# fgsea files
ref_txome     = "human_2024"
do_gsea       = as.logical("True")
fgsea_go_bp_f = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/fgsea_pineda_2024_myeloid_0.5_go_bp_2026-02-28.csv.gz"
fgsea_go_cc_f = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/fgsea_pineda_2024_myeloid_0.5_go_cc_2026-02-28.csv.gz"
fgsea_go_mf_f = "/pstore/data/brain-sc-analysis/studies/pineda_2024/output/pineda_zoom/myeloid/fgsea_pineda_2024_myeloid_0.5_go_mf_2026-02-28.csv.gz"
...
For each cluster (resolution: 0.5) the proportion of cells coming from samples associated with specific values of diagnosis, diagnosis_subtype and original_tissue_annotation is shown.
